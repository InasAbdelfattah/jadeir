    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                ...
                <h4 class="header-title m-t-0 m-b-30">مشاهدة المناطق الفرعية</h4>
                ...
                <table id="datatable-fixed-header" class="table table-striped table-hover table-condensed"
                    ...
                    @foreach($districts as $row)
                        ...
                        <tr>
                            ...
                            <td>{{ $row->city()->first() ? $row->city()->first()->name_ar : ''}}</td>
                            <td>{{ $row->name_ar }}</td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('districts.show', $row->id) }}"
