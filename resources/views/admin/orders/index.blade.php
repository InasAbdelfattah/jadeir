        ...
        <div class="col-lg-12">
            <div class="card-box">
                <div class="dropdown pull-right">
                    ...
                    <a href="{{route('orders.index')}}" style="float: left; margin-right: 15px;" class="btn btn-primary btn-sm getSelected"><i class="fa fa-eye" style="margin-left: 5px"></i>عرض جميع الطلبات
                    </a>
                    @endif
                </div>
                ...
                <form action="{{route('orders.search')}}" method="post">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="number" name="order_id" class="filteriTems" id="filterItems" placeholder="رقم الطلب"/>
                    </div>
                    <div class="col-lg-3">
                       
                        <!-- <input type="text" name="card_type" class="filteriTems" id="filterItems"/> -->
                        <select id="recordNumber" name="card_type" class="filteriTems">
                ...
                <h4 class="header-title m-t-0 m-b-30">عرض الطلبات</h4>
                            ...
                            <td>
                                ...
                                <div id="custom-modal{{ $row->id }}" class="modal-demo"
                                             ...
                                             <div class="custom-modal-text text-right" style="text-align: right !important;">
                                                <form action="{{ route('orders.confirmOrder') }}" method="post" data-id="{{ $row->id }}">
                                                    ...
                                                    <div class="form-group ">
                                                            <div class="checkbox checkbox-custom">
                                                                <input id="checkbox-signup" type="radio" value="1" required
                                                                       ...
                                                                       data-parsley-required-message="لا بد من اختيار حالة الطلب"
