        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card-box">
                    ...
                    <div class="form-group{{ $errors->has('roles') ? ' has-error' : '' }}">
                        ...
                        <select multiple="multiple" class="multi-select" id="my_multi_select1" name="roles[]" data-plugin="multiselect">
                            <option>hh</option>
            ...
            <div class="col-lg-4">
                <div class="card-box" style="overflow: hidden;">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="file" name="image" class="dropify" data-max-file-size="6M" data-show-remove="false" data-allowed-file-extensions="pdf png gif jpg jpeg" data-errors-position="outside"/>
