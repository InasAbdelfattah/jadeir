                ...
                <div class="card-box">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ $user->name or old('name') }}" class="form-control name" placeholder="اسم المستخدم بالكامل..."/>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <input type="text" name="phone" required value="{{ $user->phone or old('phone') }}"
                    ...
                    <div class="col-xs-6">
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <input type="email" name="email" parsley-trigger="change"
                                   ...
                                   class="form-control email" placeholder="البريد الإلكتروني..." />
                            @if($errors->has('email'))
                    ...
                    <div class="form-group">
                        ...
                        <input name="address" value="{{ $user->address or old('address') }}" type="text" required
                               placeholder="العنوان..." class="form-control title">
